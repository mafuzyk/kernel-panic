...
const STAGES := [
	{
		"id": "mac_classic", "act": ACT_ID, "path": "Mac::CLASSIC", "profile": "classic", "act_rule": "layered_reveal", "reveal_delay": 1.20, "title_key": "mac_classic_title", "intro_key": "mac_classic_intro", "klog_key": "mac_classic_klog", "reward_id": "macos_history_route",
		"waves": [["drone"], ["drone", "drone"], ["zombie_process", "drone"], ["drone", "lancer", "drone"]], "scale": 1.0,
	},
	{
		"id": "mac_aqua", "act": ACT_ID, "path": "Mac::AQUA", "profile": "aqua", "act_rule": "layered_reveal", "reveal_delay": 1.05, "title_key": "mac_aqua_title", "intro_key": "mac_aqua_intro", "klog_key": "mac_aqua_klog", "reward_id": "macos_aqua_clear",
		"waves": [["drone", "drone"], ["race_condition", "race_condition"], ["race_condition", "drone", "drone"], ["spewer", "race_condition", "lancer"]], "scale": 1.04,
	},
	{
		"id": "mac_darwin", "act": ACT_ID, "path": "Mac::DARWIN", "profile": "darwin", "act_rule": "layered_reveal", "reveal_delay": 0.95, "title_key": "mac_darwin_title", "intro_key": "mac_darwin_intro", "klog_key": "mac_darwin_klog", "reward_id": "macos_darwin_clear",
