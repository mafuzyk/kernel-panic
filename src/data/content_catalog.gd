...
const BESTIARY_ENTRIES := [
	...
	{"id": "permission_root", "name": "PERMISSION ROOT", "desc": "draws a permission line. sidestep its denial burst.", "threat": 9000, "threat_class": "boss", "glyph_key": "boss", "bugs": "requests root. root says no."},
