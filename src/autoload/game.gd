...
const PROGRAM_DEFS = CONTENT_CATALOG.PROGRAM_DEFS
...
const BESTIARY_MAP = CONTENT_CATALOG.BESTIARY_MAP
...
const PATCH_CODES = CONTENT_CATALOG.PATCH_CODES
const PATCH_RELATIONS = CONTENT_CATALOG.PATCH_RELATIONS
...
const PATCH_DEFS = CONTENT_CATALOG.PATCH_DEFS
const ONEHP_PATCH_EXCLUDED = CONTENT_CATALOG.ONEHP_PATCH_EXCLUDED
